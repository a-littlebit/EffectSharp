...
";
            ...
            // Initializer binding without key selector, default comparer null cast
...
";
            ...
            // Initializer binding with key selector and comparer
...
";
            ...
            var diag = AllDiags(result).FirstOrDefault(d => d.Id == "EFSP4001");
            Assert.NotNull(diag);
            Assert.Equal(DiagnosticSeverity.Error, diag!.Severity);
        }
